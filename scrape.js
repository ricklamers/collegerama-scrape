...
// https://collegerama.tudelft.nl/Mediasite/Play/c0d07ce6dcee4768be8ab1f604cb80041d?catalog=528e5b24a2fc4def870e65bd84b28a8c21
            ...
            if(err){
                ...
                if(body.d){
                    ...
                    for(var p in streams){
                        ...
                        // DEBUG
                        // streamURL = "https://www.google.com/images/srpr/logo3w.png"; // small
                        // streamURL = "http://ftp.nluug.nl/os/Linux/distr/ubuntu-releases/18.04.1/ubuntu-18.04.1-desktop-amd64.iso"; // big and fast
...
// for(var x = 0; x < 1; x ++){
//     (function(x){
//         download('https://www.asdasdgoogle.com/images/srpr/logo3w.pasng', 'data/google' + x +'.png', function(){
//             console.log('done');
//         });
//     })(x);
// }